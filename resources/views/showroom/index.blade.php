                            ...
                            <form method="POST" action="{{route('showroom.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" name="tax_year" class="form-control" id="validationDefault01" placeholder="e.gs 2021" >
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label for="validationDefault01">Amount</label>
                                        <input type="text" name="yearly_tax_amount" class="form-control" id="validationDefault01" placeholder="e.g; 45000" value="" >
                                    </div>
                                </div>
