                            ...
                            <form method="POST" action="{{route('documents.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="file" name="cnic" class="form-control"  required/>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label" for="customFile">CNIC of Father/Husband</label>
                                        <input type="file" name="father_cnic" class="form-control"  required/>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label" for="customFile">Copy of Declaration</label>
                                        <input type="file" name="declaration" class="form-control"  required/>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label" for="customFile">Copy of Purchased deed</label>
                                        <input type="file" name="purchase_deed" class="form-control"  required/>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label" for="customFile">Copy of Rent deed</label>
                                        <input type="file" name="rent_deed" class="form-control"  required/>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label" for="customFile">Electricity Bill</label>
                                        <input type="file" name="electricity_bill" class="form-control"  required/>
                                    </div>
                                </div>
                                <div class="row">
                                    <hr width="100%">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" name="equipment_voucher" class="form-control"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <br><br>
