@section('title') IRC Publishers @endsection
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">IRC Publishers</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <img src="{{asset('firstReview/'. $publisher->challan)}}" height="auto" width="100%">
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                        <a href="{{route('approve_irc_publisher', $publisher->review_id)}}" type="button" class="btn btn-primary">Approve</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
